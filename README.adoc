...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/trasherdave/sistema-bancario/Java%20CI%20with%20Maven[GitHub Workflow Status]

Relatório da cobertura de código implementada
